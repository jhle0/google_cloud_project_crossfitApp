...
import 'air_squat_result.dart';

class AirSquatPoseDetector extends StatefulWidget {
  final int targetCount;
  final int targetMinute;
  final int targetSecond;

  const AirSquatPoseDetector({
    super.key,
  ...
  @override
  State<AirSquatPoseDetector> createState() => _AirSquatPoseDetectorState();
}

class _AirSquatPoseDetectorState extends State<AirSquatPoseDetector> {
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(builder: (context)=> AirSquatResult(
                    correct: poseCount,
                    heelError: errorOne,
                    hipJointError: errorTwo,
                    hipUnderError: hipUnder,
  ...
  Future<void> _createNewCsvFile() async {
    ...
    // 새로운 CSV 파일 경로 생성
    String newCsvFilePath = '${externalDirectory.path}/AirSquat_$formattedDate.csv';
