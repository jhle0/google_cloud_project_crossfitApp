...
import 'air_squat_pose_detector.dart';

class AirSquatSettings extends StatefulWidget {
  const AirSquatSettings({super.key});

  @override
  State<AirSquatSettings> createState() => _AirSquatSettingsState();
}

class _AirSquatSettingsState extends State<AirSquatSettings> {
  int count = 0;
  int minute = 0;
  int second = 0;
                                ...
                                return AlertDialog(
                                  ...
                                  actions: <Widget>[
                                    TextButton(onPressed: (){
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(builder: (context)=>AirSquatPoseDetector(targetCount: count, targetMinute: minute, targetSecond: second)
                                        )
                                      );
                                    },
                                        child: const Text("확인")
