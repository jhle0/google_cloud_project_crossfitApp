...
class AirSquatResult extends StatefulWidget {
  const AirSquatResult({super.key,
    required this.correct,
    required this.heelError,
    required this.hipUnderError,
    required this.hipJointError,
  ...
  final int correct;
  final int heelError;
  final int hipUnderError;
  final int hipJointError;

  @override
  State<AirSquatResult> createState() => _AirSquatResultState();
}

class _AirSquatResultState extends State<AirSquatResult> {
                          ...
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              const TextSpan(
                                  text: ' 발 뒤꿈치 오류 '),
                              TextSpan(
                                text: '${widget.heelError}', // 변수 부분에 다른 스타일 적용
                                style: const TextStyle(
                          ...
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              const TextSpan(
                                  text: ' 엉덩이 하방 오류 '),
                              TextSpan(
                                text: '${widget.hipUnderError}', // 변수 부분에 다른 스타일 적용
                                style: const TextStyle(
                                  color: Colors.red, // 원하는 색상으로 변경
                                  fontWeight: FontWeight.bold, // 추가적인 스타일 적용 가능
                                ),
                        ...
                        text: TextSpan(
                          ...
                          children: <TextSpan>[
                            const TextSpan(
                                text: ' 고관절 오류 '),
                            TextSpan(
                              text: '${widget.hipJointError}', // 변수 부분에 다른 스타일 적용
                              style: const TextStyle(
                                color: Colors.red, // 원하는 색상으로 변경
                                fontWeight: FontWeight.bold, // 추가적인 스타일 적용 가능
                              ),
