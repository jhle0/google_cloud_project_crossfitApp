...
import 'overhead_squat_settings.dart';

class OverheadSquatPage extends StatefulWidget {
  const OverheadSquatPage({super.key});

  @override
  State<OverheadSquatPage> createState() => _OverheadSquatPageState();
}

class _OverheadSquatPageState extends State<OverheadSquatPage> {
  @override
  @override
              ...
              child: ElevatedButton(
                onPressed: (){
                  setState(() {
                    Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context)=> OverheadSquatSettings())
                    );
                  });
                },
